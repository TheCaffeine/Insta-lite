...
##### Cloning the repository:  
 ```bash 
 https://github.com/TheCaffeine/insta-lite.git 
```
...
* [![License](https://img.shields.io/packagist/l/loopline-systems/closeio-api-wrapper.svg)](https://github.com/TheCaffeiene/Picture-Globe/blob/master/LICENSE)  
